...
service_account = ' genes-from-space@ee-simonpahls.iam.gserviceaccount.com'
credentials = ee.ServiceAccountCredentials(service_account, '/Users/simonrabenmeister/Desktop/GEE_Key.json')
